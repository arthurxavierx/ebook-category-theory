...
![A finite infinite monkey. It's infinity can't be represented in finite media](./img/part1_chapter02.jpg){ height=2.0in }
...
This definition type checks because `undefined` evaluates to $\bot$, which is a member of any type, including `Bool`. You can even write:
